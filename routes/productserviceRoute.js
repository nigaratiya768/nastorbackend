...
router
  .route("/add_product_service")
  .post(upload.single("file_path"), Add_Product_Service);
...
router
  .route("/upload_product_service")
  .post(upload.single("file"), uploadProductAndService);
